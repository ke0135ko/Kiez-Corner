...
<noscript>Diese Seite wird nur bei aktiviertem Javascript richtig angezeigt und verarbeitet!</noscript>
...
<div>
    ...
    <ul class="flex-container">
        ...
        $queryADV = "select * from advertisements a join member m on a.memberid=m.membno left join pictures p on a.advid=p.assigned_adv where a.advtype like 'OFFER'";
            ...
            <li>
                ...
                <table class="tableAdvertisement">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="return deleteAdv(<?php echo $rowADV['ADVID']; ?>);" class="KiezButton_Adv">
